 ...
 * @author : jigpud
 */
public class StoryDetailViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    private StoryDetailViewModelFactory() {}
    ...
    public <T extends ViewModel> T create(@NonNull @NotNull Class<T> modelClass) {
        ...
        return (T) new StoryDetailViewModel(storyRepository);
    }

    public static StoryDetailViewModelFactory create() {
        return new StoryDetailViewModelFactory();
    }
}
