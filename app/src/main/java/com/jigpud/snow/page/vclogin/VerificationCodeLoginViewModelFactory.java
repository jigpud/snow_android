 ...
 * @author jigpud
 */
public class VerificationCodeLoginViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    private VerificationCodeLoginViewModelFactory() {}
    ...
    public <T extends ViewModel> T create(@NonNull @NotNull Class<T> modelClass) {
        ...
        return (T) new VerificationCodeLoginViewModel(userRepository, verificationCodeRepository);
    }

    public static VerificationCodeLoginViewModelFactory create() {
        return new VerificationCodeLoginViewModelFactory();
    }
}
