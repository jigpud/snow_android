 ...
 * @author : jigpud
 */
public class FoodDetailViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    private FoodDetailViewModelFactory() {}
    ...
    public <T extends ViewModel> T create(@NonNull @NotNull Class<T> modelClass) {
        ...
        return (T) new FoodDetailViewModel(foodRepository);
    }

    public static FoodDetailViewModelFactory create() {
        return new FoodDetailViewModelFactory();
    }
}
